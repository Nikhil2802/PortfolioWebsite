...
export default function AnimatedCircles() {
  ...
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{
        scale: isSmallScreen ? [1, 1.5, 0, 1, 1] : [1, 3, 0, 1, 1],
        opacity: [0.1, 2.0, 0.4, 2.0, 1.0, 1.0],
      ...
      <div className='rounded-full border border-red-700 opacity-40 h-[380px] w-[380px] absolute mt-20 animate-pulse sm:h-[400px] sm:w-[400px]'/>
